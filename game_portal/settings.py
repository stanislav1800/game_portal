...
SECRET_KEY = 'django-insecure-lc3&^yciigok9mqs&^7_q_)h&tm*kjf3fx+1@fx7ti!1dcc2=)'
...
INSTALLED_APPS = [
    ...
    'django_apscheduler',
    'bulletin_board.apps.NewsConfig',
    # 'bulletin_board',
    'allauth',
    'allauth.account',
...
AUTHENTICATION_BACKENDS = [
    # Требуется для входа под именем пользователя в Django admin, независимо от `allauth`
    'django.contrib.auth.backends.ModelBackend',
    # 'users.authentication.EmailAuthBackend',
    # методы аутентификации, определенные для `allauth`, такие как вход по электронной почте
